...
namespace rxWebBigBdemo.Models.Main
{
    ...
    public partial class ApplicationObject
    {
        ...
        /*  [HasOne(foreignKeys: new string[] { nameof(ApplicationObjectTypeId),}, nameof(rxWebBigBdemo.Models.Main.ApplicationObjectType.ApplicationObjects))]*/
        [ForeignKey(nameof(ApplicationObjectTypeId))]
        [InverseProperty(nameof(rxWebBigBdemo.Models.Main.ApplicationObjectType.ApplicationObjects))]
