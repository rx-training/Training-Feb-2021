...
namespace rxWebBigBdemo.Models.Main
{
    ...
    public partial class City
    {
        ...
        /* [HasOne(foreignKeys: new string[] { nameof(Country_ID),}, nameof(rxWebBigBdemo.Models.Main.Country.City))]*/
        [ForeignKey(nameof(Country_ID))]
        [InverseProperty(nameof(rxWebBigBdemo.Models.Main.Country.City))]
