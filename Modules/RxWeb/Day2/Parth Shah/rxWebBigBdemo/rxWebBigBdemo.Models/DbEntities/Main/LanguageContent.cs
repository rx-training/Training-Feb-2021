...
namespace rxWebBigBdemo.Models.Main
{
    ...
    public partial class LanguageContent
    {
        ...
        /*[HasOne(foreignKeys: new string[] { nameof(LanguageContentKeyId),}, nameof(rxWebBigBdemo.Models.Main.LanguageContentKey.LanguageContents))]*/
        [ForeignKey(nameof(LanguageContentKeyId))]
        [InverseProperty(nameof(rxWebBigBdemo.Models.Main.LanguageContentKey.LanguageContents))]
