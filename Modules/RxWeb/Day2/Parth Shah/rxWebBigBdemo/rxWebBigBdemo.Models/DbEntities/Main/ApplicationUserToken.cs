...
namespace rxWebBigBdemo.Models.Main
{
    ...
    public partial class ApplicationUserToken
    {
        ...
        /* [HasOne(foreignKeys: new string[] { nameof(UserId),}, nameof(rxWebBigBdemo.Models.Main.User.ApplicationUserTokens))]*/
        [ForeignKey(nameof(UserId))]
        [InverseProperty(nameof(rxWebBigBdemo.Models.Main.User.ApplicationUserTokens))]
