...
namespace rxWebBigBdemo.Models.Main
{
    ...
    public partial class ComponentLanguageContent
    {
        ...
        /*[HasOne(foreignKeys: new string[] { nameof(ComponentKeyId),}, nameof(rxWebBigBdemo.Models.Main.LanguageContentKey.ComponentLanguageContents))]*/
        [ForeignKey(nameof(ComponentKeyId))]
        [InverseProperty(nameof(rxWebBigBdemo.Models.Main.LanguageContentKey.ComponentLanguageContents))]
        ...
        /*  [HasOne(foreignKeys: new string[] { nameof(LanguageContentId),}, nameof(rxWebBigBdemo.Models.Main.LanguageContent.ComponentLanguageContents))]*/
        [ForeignKey(nameof(LanguageContentId))]
        [InverseProperty(nameof(rxWebBigBdemo.Models.Main.LanguageContent.ComponentLanguageContents))]
