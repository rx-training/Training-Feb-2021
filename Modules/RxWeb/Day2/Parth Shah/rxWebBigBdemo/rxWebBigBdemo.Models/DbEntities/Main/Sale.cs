...
namespace rxWebBigBdemo.Models.Main
{
    ...
    public partial class Sale
    {
        ...
        /* [HasOne(foreignKeys: new string[] { nameof(CityId),}, nameof(rxWebBigBdemo.Models.Main.City.Sales))]*/
        [ForeignKey(nameof(CityId))]
        [InverseProperty(nameof(rxWebBigBdemo.Models.Main.City.Sales))]
        ...
        /*  [HasOne(foreignKeys: new string[] { nameof(CountryId),}, nameof(rxWebBigBdemo.Models.Main.Country.Sales))]*/
        [ForeignKey(nameof(CountryId))]
        [InverseProperty(nameof(rxWebBigBdemo.Models.Main.Country.Sales))]
        ...
        /* [HasOne(foreignKeys: new string[] { nameof(CustId),}, nameof(rxWebBigBdemo.Models.Main.Customer.Sales))]*/
        [ForeignKey(nameof(CustId))]
        [InverseProperty(nameof(rxWebBigBdemo.Models.Main.Customer.Sales))]
        ...
        /*        [HasOne(foreignKeys: new string[] { nameof(ProductID),}, nameof(rxWebBigBdemo.Models.Main.Product.Sales))]*/
        [ForeignKey(nameof(ProductID))]
        [InverseProperty(nameof(rxWebBigBdemo.Models.Main.Product.Sales))]
