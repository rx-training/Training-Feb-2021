...
namespace rxWebBigBdemo.Models.Main
{
    ...
    public partial class RolePermission
    {
        ...
        /*[HasOne(foreignKeys: new string[] { nameof(ApplicationModuleId),}, nameof(rxWebBigBdemo.Models.Main.ApplicationModule.RolePermissions))]*/
        [ForeignKey(nameof(ApplicationModuleId))]
        [InverseProperty(nameof(rxWebBigBdemo.Models.Main.ApplicationModule.RolePermissions))]
        ...
        /* [HasOne(foreignKeys: new string[] { nameof(RoleId),}, nameof(rxWebBigBdemo.Models.Main.Role.RolePermissions))]*/
        [ForeignKey(nameof(RoleId))]
        [InverseProperty(nameof(rxWebBigBdemo.Models.Main.Role.RolePermissions))]
