...
namespace HumanResourceApp.Models.Main
{
    ...
    public partial class ComponentLanguageContent
    {
        ...
        [InverseProperty(nameof(HumanResourceApp.Models.Main.LanguageContentKey.ComponentLanguageContents))]
        ...
        [InverseProperty(nameof(HumanResourceApp.Models.Main.LanguageContent.ComponentLanguageContents))]
