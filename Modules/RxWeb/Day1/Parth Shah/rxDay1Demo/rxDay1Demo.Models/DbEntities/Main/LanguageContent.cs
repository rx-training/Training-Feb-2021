...
namespace rxDay1Demo.Models.Main
{
    ...
    public partial class LanguageContent
    {
        ...
        /*[HasOne(foreignKeys: new string[] { nameof(LanguageContentKeyId),}, nameof(rxDay1Demo.Models.Main.LanguageContentKey.LanguageContents))]*/
        [ForeignKey(nameof(LanguageContentKeyId))]
        [InverseProperty(nameof(rxDay1Demo.Models.Main.LanguageContentKey.LanguageContents))]
