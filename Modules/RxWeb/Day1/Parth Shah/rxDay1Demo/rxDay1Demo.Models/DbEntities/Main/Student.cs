...
namespace rxDay1Demo.Models.Main
{
    ...
    public partial class Student
    {
        ...
        /* [HasOne(foreignKeys: new string[] { nameof(CourseId),}, nameof(rxDay1Demo.Models.Main.Cours.Students))]*/
        [ForeignKey(nameof(CourseId))]
        [InverseProperty(nameof(rxDay1Demo.Models.Main.Cours.Students))]
