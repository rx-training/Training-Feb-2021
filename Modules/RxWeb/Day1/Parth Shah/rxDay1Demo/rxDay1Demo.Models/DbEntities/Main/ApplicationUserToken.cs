...
namespace rxDay1Demo.Models.Main
{
    ...
    public partial class ApplicationUserToken
    {
       ...
       /*[HasOne(foreignKeys: new string[] { nameof(UserId),}, nameof(rxDay1Demo.Models.Main.User.ApplicationUserTokens))]*/
        [ForeignKey(nameof(UserId))]
        [InverseProperty(nameof(rxDay1Demo.Models.Main.User.ApplicationUserTokens))]
