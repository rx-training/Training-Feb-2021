...
namespace rxDay1Demo.Models.Main
{
    ...
    public partial class ApplicationModule
    {
        ...
        /*[HasOne(foreignKeys: new string[] { nameof(ModuleMasterId),}, nameof(rxDay1Demo.Models.Main.ModuleMaster.ApplicationModules))]*/
        [ForeignKey(nameof(ModuleMasterId))]
        [InverseProperty(nameof(rxDay1Demo.Models.Main.ModuleMaster.ApplicationModules))]
