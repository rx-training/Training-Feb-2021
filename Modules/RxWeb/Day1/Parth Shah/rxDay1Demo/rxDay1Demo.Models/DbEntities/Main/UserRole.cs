...
namespace rxDay1Demo.Models.Main
{
    ...
    public partial class UserRole
    {
       ...
       /* [HasOne(foreignKeys: new string[] { nameof(RoleId),}, nameof(rxDay1Demo.Models.Main.Role.UserRoles))]*/
       [ForeignKey(nameof(RoleId))]
        [InverseProperty(nameof(rxDay1Demo.Models.Main.Role.UserRoles))]
        ...
        /*[HasOne(foreignKeys: new string[] { nameof(UserId),}, nameof(rxDay1Demo.Models.Main.User.UserRoles))]*/
        [ForeignKey(nameof(UserId))]
        [InverseProperty(nameof(rxDay1Demo.Models.Main.User.UserRoles))]
