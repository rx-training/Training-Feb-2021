...
namespace Day3RxwebBigB.Models.Main
{
    ...
    public partial class ComponentLanguageContent
    {
        ...
        [HasOne(foreignKeys: new string[] { nameof(ComponentKeyId),}, nameof(Day3RxwebBigB.Models.Main.LanguageContentKey.ComponentLanguageContents))]
        ...
        [HasOne(foreignKeys: new string[] { nameof(LanguageContentId),}, nameof(Day3RxwebBigB.Models.Main.LanguageContent.ComponentLanguageContents))]
