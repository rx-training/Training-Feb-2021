...
{
    public partial class dayfiveContext : DbContext
    {
        public dayfiveContext()
        {
        }

        public dayfiveContext(DbContextOptions<dayfiveContext> options)
            : base(options)
        {
        }
        ...
        {
              optionsBuilder.UseSqlServer("Server=DESKTOP-VBU96E5\\SQLEXPRESS01;Database=dayfive;Trusted_Connection=True;");
