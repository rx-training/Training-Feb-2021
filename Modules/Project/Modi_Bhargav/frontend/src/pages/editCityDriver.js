...
const EditCityForm = (props) => {
  ...
  useEffect(() => {
    DriverService.GetDriverById(cityDriver.registrationNumber).then((res) => {
      ...
      setCityDriver({
        ...
        fareDetails: drivers.fareDetails,
  ...
  const updateData = (e) => {
    ...
    DriverService.updateCityDriver(
      cityDriver.registrationNumber,
      cityDriver
    ).then((res) => {
      alert("Your Account Data Is Changed");
      props.history.push("/CityDriverData/");
    });
  };
              ...
              <form className="row g-3">
                ...
                <div className="col-md-6 text-primary h4">
                  ...
                  <input
                    ...
                    // onChange={(e) =>
                    // setCityDriver((d) => ({ ...d, fullName: e.target.value }))
                    // }
                    id="inputfname"
                    required
                  />
