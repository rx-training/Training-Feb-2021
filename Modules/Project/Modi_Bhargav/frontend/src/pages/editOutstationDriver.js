...
const EditOutstationDriver = (props) => {
  ...
  useEffect(() => {
    DriverService.GetDriverById(outstationDriver.registrationNumber).then(
      (res) => {
  ...
  }, [outstationDriver.registrationNumber]);
  ...
  const updateData = (e) => {
    ...
    DriverService.updateOutstationDriver(
      outstationDriver.registrationNumber,
      outstationDriver
    ).then((res) => {
      alert("Your Account Data Is Changed");
      props.history.push("/OutstationDriverData/");
    });
  };
              ...
              <form className="row g-3">
                ...
                <div className="text-center">
                  <button
                    type="submit"
                    onClick={updateData}
                    className="btn btn-block btn-success col-md-3 text-uppercase"
                  >
                    Edit Data
                  </button>
                </div>
...
export default EditOutstationDriver;
