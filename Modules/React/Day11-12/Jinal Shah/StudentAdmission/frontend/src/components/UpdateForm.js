...
export default class Form extends Component {
   ...
   render() {
      ...
      const { StudentFname, StudentMname, StudentLname, StudentEmail, Gender, DateOfBirth, PlaceOfBirth, Language, Country, State, City, Pincode, Enrollment, ClgName, ClgAdd, Logo, Pic, FatherFname, FatherMname, FatherLname, FatherEmail, FatherEQ, FatherProfession, FatherDesignation, FatherPhone, MotherFname, MotherMname, MotherLname, MotherEmail, MotherEQ, MotherProfession, MotherDesignation, MotherPhone, Relation, RelationPhone, ReferenceDetails, ReferenceThrough, ReferenceAddress, ReferencePhone } = this.props.data;
      const { handleChange, handleSubmit, errors, onPicChange, onLogoChange } = this.props
      return (
         <>
                        ...
                        <div className="form-group row py-2">
                           ...
                           <div className="col-sm-2">
                              <div class="form-check">
                                 <input class="form-check-input border-dark" name="Gender" type="radio" value={Gender} onChange={handleChange} />
                           ...
                           <div className="col-sm-4">
                              <div class="form-check">
                                 <input class="form-check-input border-dark" name="Gender" value={Gender} type="radio" onChange={handleChange} />
                                 <label class="form-check-label">
                                    Female
                              </label>
                              </div>
