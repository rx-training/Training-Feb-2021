...
export default class EditStudent extends Component {
  ...
  componentDidMount() {
    StudentService.getStudentById(this.state.enrollNumber).then((res) => {
      ...
      this.setState({
        ...
        Ccity: student.Ccity,
        Cstate: student.Cstate,
        Ccountry: student.Ccountry,
        Cpin: student.Cpin,
        ...
        feduQualific: student.feduQualific,
        ...
        meduQualific: student.meduQualific,
  ...
  handleChange = (e) => {
    ...
    if (this.state.checkbox === true) {
      ...
      alert("Please Checked Your check Button");
    }
  };
  ...
  updateFunction = (e) => {
    e.preventDefault();
    StudentService.updateStudent(this.state, this.state.enrollNumber).then(
      (res) => {
        this.props.history.push(`/view-studentCard/${this.state.enrollNumber}`);
      }
    );
  };
