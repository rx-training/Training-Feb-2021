...
export default class Form extends Component {
  ...
  handleSubmit = (e) => {
    ...
    StudentService.createStudent(this.state)
      .then((res) => {
  ...
  render() {
    ...
    return (
      ...
      <React.Fragment>
          ...
          <form id="form">
            ...
            <div className="form-group w-50 mx-auto mt-3 mb-3 row">
              <div className="col">
                ...
                <select className="w-100 h-75" id="city" name="selectedCity" onChange={(e)=>{this.setState({selectedCity:e.target.value})}} >
                  {this.state.submit ? (
        ...
        {/* <StudentList info={this.state.students}></StudentList> */}
      </React.Fragment>
    );
  }
}
