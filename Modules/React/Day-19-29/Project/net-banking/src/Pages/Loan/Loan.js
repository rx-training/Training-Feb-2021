...
export const Loan = (props) => {
  const [Loan, setLoan] = useState({ CRN: "", accountNo: "",amount:'',duration:'' });
  ...
  const Apply=(e)=>{
      ...
      ProjectService.credit({accountNo:Loan.accountNo,amount:Loan.amount}).then((res)=>{
          console.log(res.data);
      })
    ...
    <>
      ...
      <div className="col-md-6 mx-auto mt-5">
        <form className="bg-light p-4 m-4 mt-5" id="signUpForm">
          ...
          <button type="button" className="btn btn-primary w-100 mt-5" onClick={Apply}>
            Apply
          </button>
        </form>
      </div>
