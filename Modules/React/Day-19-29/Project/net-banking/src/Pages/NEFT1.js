...
//   const xyz = () => {};
//   const showBen = () => {
//     ProjectService.getBenificiary().then((res2) => {
//       setBen(res2.data);
...
//       setCRN(res1.data);
//     });
//   }, [props.match.params.id, customer.CRN, ben.CRN]);
//   // useEffect(() => {
//   //   ProjectService.getBenificiary().then((res2) => {
//   //     setBen(res2.data)
//   //   });
...
//                           onClick={TransferMoney(item.accountNo)}
//                         >
//                           Transfer
//                         </button>
//                       </td>
...
export const NEFT1 = (props) => {
  ...
  useEffect(async () => {
    ...
    await ProjectService.getCustomerByCRN({ CRN: customer.CRN }).then(
      async (res1) => {
        await setCRN(res1.data);
