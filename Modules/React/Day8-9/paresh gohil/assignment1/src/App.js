...
//           images : URL.createObjectURL(this.refs.logoimg.files[0]),
  ...
  changeState = (event) => {
    ...
    this.setState({city : stats.find(stat => stat.name === event.target.value).city})
  ...
  handleSubmit = (e) =>{
    ...
    const student ={
      ...
      F_Education_Qualification : this.state.F_Education_Qualification,
      ...
      M_Education_Qualification : this.state.M_Education_Qualification,
    ...
    return (
      <section>
        ...
        <form onSubmit={this.handleSubmit}>
          ...
          <input type="text" name="F_Education" value={this.state.F_Education_Qualification} onChange={this.handleChange} />
          <p style={{color:"red" ,fontSize: "15px"}}>{this.state.F_Education_Qualification?this.state.stringError:""}</p>
          ...
          <input type="text" name="M_Education" value={this.state.M_Education_Qualification} onChange={this.handleChange}/>
          <p style={{color:"red" ,fontSize: "15px"}}>{this.state.M_Education_Qualification?this.state.stringError:""}</p>
