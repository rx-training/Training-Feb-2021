                  ...
                  <div className="card-body">
                     ...
                     <form onSubmit={handleSubmit} >
                        ...
                        <div className="form-group row py-2 text-center">
                           ...
                           <div className="col-sm-8">
                              <select class="form-control border-dark" id="sel1" name="Language" value={Language} onChange={handleChange}>
                        ...
                        <div className="form-group row py-2">
                           ...
                           <div className="col-sm-8">
                              <select placeholder="Country" value={this.state.selectedCountry}
                                 onChange={this.changeCountry} className="form-control border-dark" name="Country" value={Country}>
                        ...
                        <div className="form-group row py-2">
                           ...
                           <div className="col-sm-8">
                              <select placeholder="State" value={this.state.selectedState}
                                 onChange={this.changeState} className="form-control border-dark" name="State" value={State}>
                        ...
                        <div className="form-group row py-2">
                           <label className="col-sm-4 col-form-label"></label>
                           <div className="col-sm-8">
                              <select placeholder="City" className="form-control border-dark" name="City" onChange={handleChange} value={City}>
