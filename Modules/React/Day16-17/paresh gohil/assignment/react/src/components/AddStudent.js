...
//        studentList : []
      ...
      const changeCountry = (event) => {
        setStudent({...values,country : event.target.value,States : values.countries.find(cntry => cntry.country === event.target.value).State})
      ...
      const changeState = (event) => {
        setStudent({...values,State : event.target.value,cities : values.States.find(stat => stat.name === event.target.value).city})
        // const stats = values.States
        // setStudent({...values,cities : values.States.find(stat => stat.name === event.target.value).city})
        ...
        return (
          <section>
            ...
            <form onSubmit={handleSubmit}>
                ...
                <select placeholder="country" value={values.country} onChange={changeCountry}>
