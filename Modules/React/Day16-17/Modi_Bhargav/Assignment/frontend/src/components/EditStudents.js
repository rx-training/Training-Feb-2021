...
const EditStudent = (props) => {
  ...
  useEffect(() => {
    StudentService.getStudentById(student.enrollNumber).then((res) => {
      let students = res.data;
      console.log(students);
      setStudent({
        ...student,
        enrollNumber: students.enrollNumber,
        Img: students.Img,
        Logo: students.Logo,
        ...
        Ccity: students.Ccity,
        Cstate: students.Cstate,
        Ccountry: students.Ccountry,
        Cpin: students.Cpin,
        ffirstName: students.ffirstName,
        fmiddleName: students.fmiddleName,
        flastName: students.flastName,
        Femail: students.Femail,
        Fnumber: students.Fnumber,
        feduQualific: students.feduQualific,
        Fprofession: students.Fprofession,
        Fdesignation: students.Fdesignation,
        mfirstName: students.mfirstName,
        mmiddleName: students.mmiddleName,
        mlastName: students.mlastName,
        Memail: students.Memail,
        Mnumber: students.Mnumber,
        meduQualific: students.meduQualific,
        Mprofession: students.Mprofession,
        Mdesignation: students.Mdesignation,
      });
    });
  ...
  const updateFunction = (e) => {
    ...
    if (student.checkbox === true) {
      StudentService.updateStudent(student, student.enrollNumber).then(
        (res) => {
          props.history.push(`/view-studentCard/${student.enrollNumber}`);
        }
      );
    } else {
