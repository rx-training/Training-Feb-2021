...
export default function formPage3(props) {
  const { refname, telno, address, simg, cimg, cname } = props.student;
    ...
    <>
      ...
      <div className="row mb-2">
        ...
        </div>
        {
          <div className="col-3 ps-0">
            <img
              src={typeof simg === "object" ? URL.createObjectURL(simg) : simg}
              alt=""
              height="80"
              width="100%"
            />
      ...
      <div className="row mb-2">
        ...
        </div>
        {
          <div className="col-3 ps-0">
            <img
              src={typeof cimg === "object" ? URL.createObjectURL(cimg) : cimg}
