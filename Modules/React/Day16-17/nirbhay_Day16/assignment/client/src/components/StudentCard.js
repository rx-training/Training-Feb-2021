...
import { FaToggleOn, FaToggleOff, FaTimes, FaUserEdit } from "react-icons/fa";
...
export default function StudentCard(props) {
  ...
  const showDeleteConfirm = props.showDeleteConfirm;
  const showEditConfirm = props.showEditConfirm;
  ...
  return (
    <div className="card mb-3 w-100">
      <div className="row g-0">
        ...
        <div className="col-md-6">
          <div className="card-body">
            <h5 className="card-title">{fname + " " + mname + " " + lname}</h5>
      ...
      <div className="buttonDiv">
        <button type="button" id="btnedit" onClick={() => showEditConfirm(_id)}>
          <FaUserEdit />
        </button>
        <button
          type="button"
