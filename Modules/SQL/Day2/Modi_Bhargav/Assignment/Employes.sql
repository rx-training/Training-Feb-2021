...
/*****  6. Get employee details from Employees table whose Employee name are not "Neena" and "Lex" *****/
...
/***** 3. Write a SQL statement to change the Email and CommissionPct column of employees table with not available and 0.10 for those employees whose DepartmentID
is 110.    *****/
...
/***** 4. Write a SQL statement to change the Email column of employees table with not available for those employees whose DepartmentID is 80 and gets a
commission is less than 20%  *****/

UPDATE Employees SET Email = 'Not Available' WHERE DepartmentID = 80  AND CommissionPct < 0.20
SELECT * FROM Employees WHERE DepartmentID = 80 AND CommissionPct <0.20

/***** 5. Write a SQL statement to change the Email column of employees table with ‘not available’ for those employees who belongs to the
         ‘Accouning’ department.*****/
UPDATE Employees SET Email = 'Not Available' WHERE Department = 'Accounting';
SELECT * FROM Employees WHERE Department = 'Accounting';


/***** 5. Write a SQL statement to change salary of employee to 8000 whose ID is 105, if the existing salary is less than 5000. ****/
UPDATE Employees SET Salary = 8000 WHERE EmployeeID = 105 AND Salary < 5000
SELECT * FROM Employees WHERE EmployeeID = 105

/***** 6. Write a SQL statement to change job ID of employee which ID is 118, to SH_CLERK if the employee belongs to department, which ID is 30 
...
/***** 7. Write a SQL statement to increase the salary of employees under the department 40, 90 and 110 according to the company rules that,
...
/***** 8. Write a SQL statement to increase the minimum and maximum salary of PU_CLERK by 2000 as well as the salary for those employees by 20% 
