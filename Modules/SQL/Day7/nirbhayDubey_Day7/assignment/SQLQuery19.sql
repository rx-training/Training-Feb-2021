...
INSERT INTO Day4.Employees (EmployeeID,FirstName,LastName , Email, PhoneNumber, HireDate, JobId, Salary, CommissionPct, ManagerID, DepartmentID) VALUES
...
CREATE TABLE Day5.Employees(
	...
	MANAGER_ID int CONSTRAINT FkMid FOREIGN KEY REFERENCES Day5.Employees(EMPLOYEE_ID) 
)

CREATE TABLE Day5.Incentive(
	EMPLOYEE_REF_ID int CONSTRAINT FkIeid FOREIGN KEY REFERENCES Day5.Employees(EMPLOYEE_ID),
	INCENTIVE_DATE date NOT NULL,
	INCENTIVE_AMOUNT int NOT NULL
)

INSERT INTO Day5.Employees
(
	FIRST_NAME,
	LAST_NAME,
	SALARY,
