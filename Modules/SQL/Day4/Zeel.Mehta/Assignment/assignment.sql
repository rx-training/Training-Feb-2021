...
SELECT RANK() OVER( ORDER BY SALARY DESC) [D_RANK],Salary,FirstName FROM Employees 
GO
...
SELECT SUM(SALARY) AS TOTAL_SALARY,DepartmentID FROM Employees GROUP BY DepartmentID ORDER BY TOTAL_SALARY DESC
GO

SELECT MAX(SALARY) AS TOTAL_SALARY,DepartmentID FROM Employees GROUP BY DepartmentID ORDER BY TOTAL_SALARY ASC
GO

SELECT MIN(SALARY) AS TOTAL_SALARY,DepartmentID FROM Employees GROUP BY DepartmentID ORDER BY TOTAL_SALARY ASC
GO

SELECT SUM(SALARY) AS TOTAL_SALARY,DepartmentID FROM Employees GROUP BY DepartmentID HAVING  SUM(SALARY)>50000 ORDER BY TOTAL_SALARY
GO
