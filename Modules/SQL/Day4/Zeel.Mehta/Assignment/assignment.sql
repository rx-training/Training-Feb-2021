...
SELECT MAX(SALARY) AS TOTAL_SALARY,DepartmentID FROM Employees GROUP BY DepartmentID ORDER BY TOTAL_SALARY 
GO

SELECT MIN(SALARY) AS TOTAL_SALARY,DepartmentID FROM Employees GROUP BY DepartmentID ORDER BY TOTAL_SALARY 
GO
