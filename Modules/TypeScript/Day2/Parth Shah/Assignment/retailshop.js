...
var inv = [{ InventoryId: 1, InventoryName: 'newspaper', InventoryQuantity: 15, InventoryPrice: 1500, InvDescription: 'Only Gujarat samachar' },
...
//create class
var RetailStocks = /** @class */ (function () {
    function RetailStocks() {
    }
    //make function for place order
    RetailStocks.prototype.Place = function (id, qty) {
        var order = inv.filter(function (i) { return i.InventoryId == id; });
        if (qty > 4) {
            if (order[0] == null) {
                console.log('==================================');
    ...
    RetailStocks.prototype.StockAvailaible = function () {
