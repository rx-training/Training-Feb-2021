...
namespace CrudAngular.Models
{
    public partial class StudContext : DbContext
    {
        ...
        {
            optionsBuilder.UseSqlServer("Data Source=DESKTOP-VBU96E5\\SQLEXPRESS01;Initial Catalog=demoCrud;Integrated Security=True");
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Student>(entity =>
            {
                ...
                entity.Property(e => e.RphoneNo)
                    .HasMaxLength(50)
                    .HasColumnName("RPhoneNo");
            });
