...
export class StudentFormComponent implements OnInit {
  ...
  constructor(
    ...
    private studentServiService:StudentServiService
  ) { 
    ...
    this.IStudent = this.fb.group({
      ...
      ReferenceAddress: this.fb.group({
        ...
        Country: ['',[ Validators.required,Validators.minLength(3),this.patternValidator]],
        Pin:['',[Validators.required,Validators.minLength(6),Validators.maxLength(6),this.numberValidation ]],
        PhoneNo:['',[Validators.required,Validators.minLength(10),Validators.maxLength(10),this.numberValidation ]]
     })
  ...
  ngOnInit(): void {
    this.studentServiService.getStudent().subscribe( (data : Student[])=>{
      this.StudentList =data
  })
}

delete(id){
  this.studentServiService.deleteStudent(id).subscribe(()=>console.log('user deleted'));
  location.reload();
}


SubmitData(){
  this.studentServiService.postStudent(
    {
      ...
      rPhoneNo:this.RefPhoneNo.value
...
edit(student){
  ...
  this.RefPhoneNo.setValue(student.rPhoneNo)

}

update(){
  this.studentServiService.putStudent(this.id,
    { id : this.id,
      firstName:this.Fname.value,
      middlename:this.Mname.value,
      lastName:this.Lname.value,
...
get Fname(){return this.IStudent.controls.Name.get('FName');}
  ...
  get RefPhoneNo(){return this.IStudent.controls.ReferenceAddress.get('PhoneNo');}
